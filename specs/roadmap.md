...
- Stale spec detection — flag when code has changed a lot but specs haven't
- Meeting → decisions pipeline — paste a transcript, get a decisions.md draft

## Later / maybe

- Team UI for ownership/configuration (replaces manual team.md editing)
- Onboarding summary — AI reads specs and generates a "start here" for new team members
